...
<html>
  ...
  <head>
	...
	<script type="text/javascript" src="/payroll/salarylever/salarylever.js"></script>
    <style>
        /*把table中的复选框居中*/
      ...
      <table class="layui-table" id="layTable" lay-filter="layTable">
          <script type="text/html" id="toolbarDemo">
              <div class="layui-btn-container">
                  ...
                  <button class="layui-btn" onclick="x_admin_show('添加用户','/payroll/salarylever/salaryLeverAdd')"><i class="layui-icon"></i>添加</button>
              </div>
          </script>
